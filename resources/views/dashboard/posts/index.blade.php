...
@section('container')
    ...
    <a href="/dashboard/posts/create" class="text-decoration-none btn btn-success mb-3"><i class="bi bi-plus-circle"></i> Add Post</a>
        ...
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <td class="justify-content-center d-flex">
                    ...
                    <a href="{{route('posts.edit', $post->slug)}}" class="badge bg-warning mx-2"><span data-feather="edit"></span></a>
